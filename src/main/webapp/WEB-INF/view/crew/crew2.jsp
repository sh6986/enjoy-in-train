					...
					<div>
						<table style="width: 500px; margin: 20px auto 0px; border-spacing: 0px; float: left;">
							<tr>
							    ...
							    <td style="padding: 0 0 15px 15px;">
							    	<p style="margin-top: 1px; margin-bottom: 5px;">
							        	<input type="text" name="crewId" id="crewId" value="${dto.crewId}" onchange="crewIdCheck();" style="width: 95%; font-weight: bold;" readonly="readonly" maxlength="15" placeholder="아이디">
							        </p>
							    </td>
							</tr>
							<tr>
							    ...
							    <td style="padding: 0 0 15px 15px;">
							    	<p style="margin-top: 1px; margin-bottom: 5px;">
							        	<input type="password" name="crewPwd" maxlength="15" style="width:95%;" placeholder="패스워드">
							        </p>
							    </td>
							</tr>
							<tr>
							...
							<tr>
							    ...
							    <td style="padding: 0 0 15px 15px;">
							    	<p style="margin-top: 1px; margin-bottom: 5px;">
							        	<input type="text" name="crewName" value="${dto.crewName}" maxlength="30" style="width: 95%; font-weight: bold;" readonly="readonly" placeholder="이름">
							        </p>
							      </td>
							  </tr>
							  <tr>
